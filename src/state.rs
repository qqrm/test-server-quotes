...
impl State {
    pub fn new() -> State {
        ...
        let quotes = vec![
            r#"The ungodly ... reasoned unsoundly, saying to themselves,...
            ...
            for what is weak proves itself to be useless."#
                .to_string(),
            r#"Thus they reasoned, but they were led astray, ...
            for God created us for incorruption,
            and made us in the image of his own eternity."#
                .to_string(),
            r#"In the memory of virtue is immortality,
            ...
            throughout all time it marches, crowned in triumph."#
                .to_string(),
            r#"What has our arrogance profited us?
